...
@Component({
  ...
  templateUrl: './devolucao-form.page.html',
  styleUrls: ['./devolucao-form.page.scss'],
})
export class DevolucaoFormPage implements OnInit {
  userCurrent: any = {};
  filters: any = {};
      ...
      buttons: [
        {
        ...
        },
         {
          ...
          handler: (res) => {
            ...
            this.message.load_present();
            this.service.updateDevolucao(this.dados.uuid, this.dados)
            .then(res => {
              this.navCtrl.back();
            }).finally(() => this.message.load_dismiss());
          }
      ...
      buttons: [
        ...
        },
        {
          ...
          handler: (res) => {
            ...
            this.message.load_present();
            this.service
              .updateDevolucao(this.dados.uuid, this.dados)
              .then(async () => {
                // this.navCtrl.back();
